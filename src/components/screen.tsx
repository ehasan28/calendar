    ...
    <View style={[styles.fill, { backgroundColor: theme.background }]}>
      {scroll ? (
        <ScrollView style={styles.fill} contentContainerStyle={styles.center} keyboardShouldPersistTaps="handled">
          <View style={[styles.inner, pad && { paddingHorizontal: Spacing.three }, { paddingTop: padTop, paddingBottom: padBottom }]}>
            {children}
          </View>
        </ScrollView>
      ) : (
        <View style={[styles.inner, styles.fill, pad && { paddingHorizontal: Spacing.three }, { paddingTop: padTop, paddingBottom: padBottom }]}>
          {children}
        </View>
      )}
    </View>
